<template>
  <div el:waterfall="" class="waterfall" image-width="296">
    ...
    <div class="nodata" v-if="images.length===0"><img src="../../assets/image/me/nodata.png" alt=""><div>暂无数据</div></div>
    ...
    methods:{
      ...
      async deleteP(id) {
        ...
        this.heightArray=[],
            ...
            this.count= 0,
            this.images = []
        const res = await this.$http.delete(`rest/photo/${id}`)
      ...
      download() {
        ...
        image.onload = function() {
          ...
          a.download = that.pop.name || "photo"; // 设置图片名称
          a.href = url; // 将生成的URL设置为a.href属性
          a.dispatchEvent(event); // 触发a的单击事件
        };
        image.src = this.pop.img;
      },
      loadImgHeight() {
